...
const defaultSendSound = 'https://cdn.jsdelivr.net/gh/growtheffectai/GrowthEffect-Chat-Component@latest/src/assets/send_message.mp3';
    ...
    >
      ...
      <div class="w-full flex items-end justify-between">
        ...
        <ShortTextInput
          ...
          placeholder={props.placeholder ?? 'Sorunuzu buraya yazın.'}
        />
