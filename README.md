...
Javascript library to display growtheffect chatbot on your website

![GrowthEffect](https://github.com/GrowthEffect/GrowthEffect-Chat-Component/blob/main/images/ChatEmbed.gif?raw=true)
...
A development server will be running on http://localhost:5678 automatically. Update `public/index.html` to connect directly to GrowthEffect:
...
<script type="module">
  ...
  Chatbot.init({
    chatflowid: '91e9c803-5169-4db9-8207-3c0915d71c5f', // Add your GrowthEffect chatflowid
    apiHost: 'https://your-growtheffect-instance.com', // Add your GrowthEffect apiHost
  });
</script>
```
...
```html
<script type="module">
  import Chatbot from 'https://cdn.jsdelivr.net/npm/growtheffect-embed/dist/web.js';
  Chatbot.init({
...
<growtheffect-fullchatbot></growtheffect-fullchatbot>
```
...
<script type="module">
  ...
  Chatbot.init({
    ...
    theme: {
      ...
      disclaimer: {
        title: 'Disclaimer',
        message: 'By using this chatbot, you agree to the <a target="_blank" href="https://growtheffect.co/terms">Terms & Condition</a>',
        textColor: 'black',
        buttonColor: '#3b82f6',
      ...
      chatWindow: {
        ...
        footer: {
          textColor: '#303235',
          text: 'Powered by',
          company: 'GrowthEffect',
          companyLink: 'https://growtheffect.co',
        },
      },
    },
  });
...
The GrowthEffect Embed Proxy Server enhances the security of your chatbot implementation by acting as a protective intermediary layer. This server eliminates the need to expose sensitive GrowthEffect instance details in your frontend code and provides several key security benefits:

![Proxy Server](https://github.com/GrowthEffect/GrowthEffect-Chat-Component/blob/main/images/proxyserver.png?raw=true)

- **Enhanced Security**: Conceals your GrowthEffect API host and chatflow IDs from client-side exposure
- **Access Control**: Implements strict domain-based restrictions for chatbot embedding
- **Secure Communication**: Acts as a secure gateway for all interactions between your website and GrowthEffect instance
...
API_HOST=https://your-growtheffect-instance.com
GROWTHEFFECT_API_KEY=your-api-key
...
# chatflowId: The UUID of your GrowthEffect chatflow
...
4. Once the proxy server is running in production, you will be able to embed your chatbots safely without exposing your GrowthEffect API host and chatflow IDs as below:
...
Source code in this repository is made available under the [MIT License](https://github.com/GrowthEffect/GrowthEffect-Chat-Component/blob/master/LICENSE.md).
